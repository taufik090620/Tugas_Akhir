...
class Data_peminjam_model extends MY_Model {
    ...
    public function getPeminjamJoin($user_id)
	{
        ...
        $this->db->where('data_pinjam.id_pengguna', $user_id); // Filter berdasarkan ID user yang login
        $this->db->order_by('data_pinjam.id', 'DESC');
        $query = $this->db->get();
		return $query->result();
	}
    

    public function getPeminjamJoinByID($id)
	{
    ...
    public function getListPeminjamKosong()
	{
    ...
    public function getListPeminjamEdit()
	{
        $this->db->select('data_pinjam.id, data_pinjam.nama_barang, data_pinjam.stock, data_pinjam.alasan_pinjam, data_pinjam.tanggal_terpakai, data_inventaris.nama_barang, data_inventaris.nama_barang');    
        $this->db->from('data_inventaris');
        $this->db->join('data_pinjam', 'data_pinjam.nama_barang = data_inventaris.nama_barang', 'left');
