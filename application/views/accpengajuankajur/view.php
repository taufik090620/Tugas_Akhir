      			...
      			<table class="table table-bordered table-striped">
      				<tbody>
      					<tr>
      						...
      						<td><?php echo $accpengajuankajur->jurusan ?></td>
      					</tr>
      					<tr>
                          <td width="160"><strong>Nama Pemohon</strong>:</td>
      						<td><?php echo $accpengajuankajur->nama_pemohon ?></td>
      					</tr>
      					<tr>
                          <td width="160"><strong>Nama Alat</strong>:</td>
      						<td><?php echo $accpengajuankajur->nama_alat_acc?></td>
      					</tr>
      					<tr>
                          <td width="160"><strong>Spesifikasi</strong>:</td>
      						<td><?php echo $accpengajuankajur->spesifikasi_acc ?></td>
      					</tr>
      					<tr>
                          <td width="160"><strong>Satuan Alat</strong>:</td>
      						<td><?php echo $accpengajuankajur->satuan_acc ?></td>
      					</tr>
      					
      					<tr>
                          <td width="160"><strong>Harga Satuan</strong>:</td>
      						<td><?php echo $accpengajuankajur->harga_satuan_acc ?></td>
      					</tr>
                          
      					<tr>
                          <td width="160"><strong>Tahun Pengajuan</strong>:</td>
      						<td><?php echo $accpengajuankajur->tahun_pengajuan_acc ?></td>
      					</tr>
                          <tr>
                          <td width="160"><strong>Status</strong>:</td>
      						<td><?php echo $accpengajuankajur->status_acc ?></td>
      					</tr>
						  <td width="160"><strong>Link Pembelian</strong>:</td>
							  <td>
								<?php if (!empty($accpengajuankajur->link_beli_acc)): ?>
									<a href="<?php echo $accpengajuankajur->link_beli_acc ?>" target="_blank"><?php echo $accpengajuankajur->link_beli_acc ?></a>
								<?php else: ?>
									<?php echo $accpengajuankajur->link_beli_acc ?>
								<?php endif; ?>
							</td>
