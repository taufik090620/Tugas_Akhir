      			...
      			<table class="table table-bordered table-striped">
      				<tbody>
                          ...
                          <td width="160"><strong>Nama Alat</strong>:</td>
      						<td><?php echo $data_pengajuan->nama_alat?></td>
      					</tr>
      					<tr>
                          <td width="160"><strong>Spesifikasi</strong>:</td>
      						<td><?php echo $data_pengajuan->spesifikasi ?></td>
      					</tr>
      					<tr>
                          <td width="160"><strong>Satuan Alat</strong>:</td>
      						<td><?php echo $data_pengajuan->satuan ?></td>
      					</tr>
      					
      					<tr>
                          <td width="160"><strong>Harga Satuan</strong>:</td>
      						<td><?php echo $data_pengajuan->harga_satuan ?></td>
      					</tr>
                          
      					<tr>
                          <td width="160"><strong>Tahun Pengajuan</strong>:</td>
      						<td><?php echo $data_pengajuan->tahun_pengajuan ?></td>
      					</tr>
                          <tr>
                          <td width="160"><strong>Status</strong>:</td>
      						<td><?php echo $data_pengajuan->status ?></td>
      					</tr>
						  <td width="160"><strong>Link Pembelian</strong>:</td>
							  <td>
								<?php if (!empty($data_pengajuan->link_beli)): ?>
									<a href="<?php echo $data_pengajuan->link_beli ?>" target="_blank"><?php echo $data_pengajuan->link_beli ?></a>
								<?php else: ?>
									<?php echo $data_pengajuan->link_beli ?>
								<?php endif; ?>
							</td>
