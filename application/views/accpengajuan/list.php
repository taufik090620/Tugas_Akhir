        ...
        <div class="row">
            ...
            <div class="card">
                ...
                <table id="example1" class="table table-bordered table-hover table-striped">
                  ...
                  <tbody>
                  <?php foreach ($accpengajuan as $row): ?>
                    <tr>
                    <td><?php echo $row->jurusan?></td>
                      ...
                      <div style="text-align: center; margin-top: 10px;">
                            <?php if (hasPermissions('pengajuan_view')): ?>
                              <a href="<?php echo url('accpengajuan/view/'.$row->id) ?>" class="btn btn-sm btn-info" title="<?php echo lang('view_approve') ?>" data-toggle="tooltip">
                                <i class="fa fa-eye"></i>
                              </a>
                            <?php endif ?>
                          </div>
