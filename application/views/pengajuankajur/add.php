        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active"><?php echo lang('tambah_pengajuan') ?></li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
...
<?php echo form_open_multipart('datapengajuankajur/save', [ 'class' => 'form-validate', 'autocomplete' => 'off' ]); ?>
    ...
    <div class="col-sm-6">
      ...
      <div class="card">
        ...
        <div class="form-group">
          ...
          <div class="form-group">
            ...
            <select name="id_jurusan" id="formClient-Role" class="form-control select2" required>
              ...
              <?php $sel = $row->id == $data_pengajuankajur->id_jurusan ? 'selected' : ''; ?>
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" name="nama_alat" id="formClient-Name" required placeholder="nama alat" />
          </div>
          <div class="form-group">
            <label for="formClient-Name">Jumlah Alat </label>
            <input type="number" class="form-control" name="banyak_alat" id="formClient-Name" required placeholder="Jumlah Alat Yang Diajukan" />
          </div>
          <div class="form-group">
            <label for="formClient-Name">Tahun Pengajuan </label>
            <input type="date" class="form-control" name="tahun_pengajuan" minlength="6" id="formClient-Password" required placeholder="2019-01-20">
          </div>
        </div>
        <!-- /.card-body -->
      ...
      <div class="card">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" name="satuan" id="formClient-Name" required placeholder="Satuan Alat">
          </div>
        <div class="form-group">
          <label for="formClient-ConfirmPassword">Harga Alat</label>
          <input type="text" class="form-control" name="harga_satuan" id="harga_satuan" placeholder="Rp. 5.000">
          </div>
        </div>
        <!-- /.card-body -->
    ...
    <div class="col-sm-6">
      ...
      <div class="card">
        ...
        <div class="form-group">
            ...
            <textarea type="text" class="form-control" name="spesifikasi" id="formClient-Address" placeholder="Spesifikasi Alat" rows="3"></textarea>
          </div>
          <div class="form-group">
            <label for="formClient-Address">Link Pembelian</label>
            <textarea type="text" class="form-control" name="link_beli" id="formClient-Address" placeholder="Link Pembelian" rows="3"></textarea>
          </div>
