        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            ...
            <li class="breadcrumb-item"><a href="<?php echo url('/dashboard') ?>"><?php echo lang('home') ?></a></li>
              ...
              <li class="breadcrumb-item active"><?php echo lang('tambah_kerusakan_pengguna') ?></li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
...
<?php echo form_open_multipart('datalaporkankerusakanpengguna/save', [ 'class' => 'form-validate', 'autocomplete' => 'off' ]); ?>
